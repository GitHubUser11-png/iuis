...
namespace IUIS.Tests
{
    ...
    public sealed class StudentServiceDomainTests
    {
        ...
        {
            var book = CreateBook();
            book.AddCopy("LCP-2026-000002", "BC-0002", LibraryCopyCondition.Damaged,
                CreatedAtUtc.AddMinutes(2), LibrarianId);
            book.AddCopy("LCP-2026-000003", "BC-0003", LibraryCopyCondition.Good,
                CreatedAtUtc.AddMinutes(3), LibrarianId);
            book.MarkCopyOnLoan("LCP-2026-000001", CreatedAtUtc.AddMinutes(4), LibrarianId);
            book.MarkCopyLost("LCP-2026-000003", CreatedAtUtc.AddMinutes(5), LibrarianId);
            ...
            Assert.AreEqual(book.TotalCopies,
                book.AvailableCopies + book.ActiveBorrowedCopies
                + book.MaintenanceCopies + book.LostCopies);
        }
        ...
        public void BorrowingSupportsIssueOverdueRenewAndReturn()
        {
            ...
            borrowing.MarkOverdue(new InstitutionLocalDate(2026, 1, 11),
                CreatedAtUtc.AddMinutes(2), LibrarianId);
            borrowing.Renew(new InstitutionLocalDate(2026, 1, 20),
                CreatedAtUtc.AddMinutes(3), LibrarianId);
            borrowing.Return(CreatedAtUtc.AddMinutes(4), LibraryCopyCondition.Good, LibrarianId);
        ...
        public void CounselingCaseSeparatesConfidentialSessionAndReleasedSummary()
        {
            ...
            counselingCase.RecordSession("CSN-2026-000001", CreatedAtUtc.AddHours(2),
                CounselingRiskLevel.Elevated, "Confidential internal counseling narrative.",
                CreatedAtUtc.AddHours(2), ActorId);
            counselingCase.ReleaseSessionSummary("CSR-2026-000001", "CSN-2026-000001",
                "CRL-2026-000001", "Released summary suitable for the recipient.",
                CreatedAtUtc.AddHours(3), ActorId);

            Assert.AreEqual("Confidential internal counseling narrative.",
                counselingCase.ConfidentialSessions[0].InternalNotes);
            Assert.AreEqual("Released summary suitable for the recipient.",
        ...
        public void CounselingReleaseAuthorizationAllowsOnlyExactReleasedScope()
        {
            ...
            Assert.IsTrue(authorization.Allows(
                CounselingReleaseScope.ReleasedSessionSummary, CreatedAtUtc.AddHours(2)));
            Assert.IsFalse(authorization.Allows(
                CounselingReleaseScope.ReferralSummary, CreatedAtUtc.AddHours(2)));
        }
        ...
        {
            var authorization = CreateCounselingReleaseAuthorization();
            authorization.Revoke("Student withdrew authorization.",
                CreatedAtUtc.AddHours(2), ActorId);
            Assert.IsFalse(authorization.Allows(
                CounselingReleaseScope.ReleasedSessionSummary, CreatedAtUtc.AddHours(3)));
        }
        ...
        public void CounselingCaseCompletesRequestedToClosedLifecycle()
        {
            var counselingCase = CreateAssignedCounselingCase();
            counselingCase.RecordSession("CSN-2026-000001", CreatedAtUtc.AddHours(2),
                CounselingRiskLevel.Routine, "Internal notes.",
                CreatedAtUtc.AddHours(2), ActorId);
            counselingCase.Close("Counseling objectives completed.",
                CreatedAtUtc.AddHours(3), ActorId);
        ...
        public void DisciplineCaseCompletesNoticeResponseDecisionLifecycle()
        {
            ...
            disciplineCase.RecordStudentResponse("DSR-2026-000001", "Student response.",
                "response-evidence-001", CreatedAtUtc.AddHours(4), ActorId);
            disciplineCase.RecordFinding("DFN-2026-000001", true,
                "Restricted investigation finding.", CreatedAtUtc.AddHours(5), ActorId);
            disciplineCase.PrepareDecision("DDC-2026-000001",
                DisciplineDecisionOutcome.CorrectiveAction, "Restricted rationale.",
                "Complete assigned corrective action.", CreatedAtUtc.AddHours(6), ActorId);
            disciplineCase.ReleaseDecision("Resolved with corrective action.",
                CreatedAtUtc.AddHours(7), ActorId);
        ...
        public void ReleasedDisciplineDecisionDoesNotReplaceInternalRationale()
        {
            var disciplineCase = CreateNoticeReleasedDisciplineCase();
            disciplineCase.RecordFinding("DFN-2026-000001", true,
                "Restricted finding.", CreatedAtUtc.AddHours(4), ActorId);
            disciplineCase.PrepareDecision("DDC-2026-000001",
                DisciplineDecisionOutcome.Warning, "Restricted decision rationale.",
                "Written warning.", CreatedAtUtc.AddHours(5), ActorId);
            disciplineCase.ReleaseDecision("Released outcome summary.",
                CreatedAtUtc.AddHours(6), ActorId);

            Assert.AreEqual("Restricted decision rationale.",
                disciplineCase.Decision.InternalRationale);
            Assert.AreEqual("Released outcome summary.",
        ...
        public void ClinicAppointmentCompletesWithConsultationReference()
        {
            ...
            appointment.Schedule(CreatedAtUtc.AddDays(1), ClinicianEmployeeId,
                CreatedAtUtc.AddMinutes(1), ActorId);
            appointment.Confirm(CreatedAtUtc.AddMinutes(2), ActorId);
            appointment.CheckIn(CreatedAtUtc.AddDays(1), ActorId);
            appointment.Complete("CON-2026-000001",
                CreatedAtUtc.AddDays(1).AddMinutes(30), ActorId);
        ...
        public void MedicalRecordSeparatesConfidentialConsultationAndReleasedSummary()
        {
            ...
            record.ReleaseConsultationSummary("MRS-2026-000001", "CON-2026-000001",
                "Released consultation summary.", CreatedAtUtc.AddHours(3), ActorId);

            Assert.AreEqual("Confidential clinical notes.",
                record.ConfidentialConsultations[0].InternalClinicalNotes);
            Assert.AreEqual("Released consultation summary.",
        ...
        public void MedicalClearanceFollowsRequestReviewIssueLifecycle()
        {
            ...
            clearance.Issue("MCH-2026-000003", "MCN-2026-000001",
                new InstitutionLocalDate(2026, 1, 2),
                new InstitutionLocalDate(2026, 1, 31),
                "Student is medically cleared.", CreatedAtUtc.AddHours(2), ActorId);
        ...
        public void RevokedMedicalClearanceRetainsNumberAndHistory()
        {
            ...
            clearance.Revoke("MCH-2026-000004", "Material medical information changed.",
                CreatedAtUtc.AddHours(3), ActorId);
        ...
        {
            var book = new LibraryBook("LBK-2026-000001", "978-971-0000-01-1",
                "Integrated Systems", "A. Author", "University Press",
                "Information Technology", CreatedAtUtc, LibrarianId);
            book.AddCopy("LCP-2026-000001", "BC-0001", LibraryCopyCondition.Good,
                CreatedAtUtc.AddMinutes(1), LibrarianId);
            return book;
        }

        private static LibraryBorrowing CreateBorrowing(InstitutionLocalDate dueDate)
        {
            return new LibraryBorrowing("BRW-2026-000001", StudentId,
                "LBK-2026-000001", "LCP-2026-000001", dueDate,
                CreatedAtUtc, LibrarianId);
        }

        private static CounselingCase CreateCounselingCase()
        {
            return new CounselingCase("CNS-2026-000001", StudentId,
                CreatedAtUtc.AddDays(1), "Student requested counseling support.",
                CreatedAtUtc, ActorId);
        }

        private static CounselingCase CreateAssignedCounselingCase()
        {
            var counselingCase = CreateCounselingCase();
            counselingCase.ConfirmAppointment(CreatedAtUtc.AddDays(1),
                CreatedAtUtc.AddMinutes(1), ActorId);
            counselingCase.AssignCounselor(CounselorEmployeeId,
                CreatedAtUtc.AddMinutes(2), ActorId);
            return counselingCase;
        }

        private static CounselingReleaseAuthorization CreateCounselingReleaseAuthorization()
        {
            return new CounselingReleaseAuthorization("CRL-2026-000001",
                "CNS-2026-000001", StudentId, "Authorized university office",
                "Confirm released counseling outcome.",
                CounselingReleaseScope.ReleasedSessionSummary,
                CreatedAtUtc.AddHours(1), CreatedAtUtc.AddDays(1),
                CreatedAtUtc, ActorId);
        }

        private static DisciplineCase CreateDisciplineCase()
        {
            return new DisciplineCase("DIN-2026-000001", StudentId, CreatedAtUtc,
                "Main Campus", "Restricted incident narrative.", ActorId,
                CreatedAtUtc, ActorId);
        }
        ...
        private static DisciplineCase CreateNoticeReleasedDisciplineCase()
        {
            ...
            disciplineCase.BeginReview(CreatedAtUtc.AddHours(1), ActorId);
            disciplineCase.ConvertToViolation("VIO-2026-000001", "CODE-1",
                "Violation description.", DisciplineSeverity.Moderate,
                CreatedAtUtc.AddHours(2), ActorId);
            disciplineCase.ReleaseNotice("DNT-2026-000001", "Released notice summary.",
                new InstitutionLocalDate(2026, 1, 15), CreatedAtUtc.AddHours(3), ActorId);
            return disciplineCase;
        }

        private static ClinicAppointment CreateClinicAppointment()
        {
            return new ClinicAppointment("CAP-2026-000001", StudentId,
                CreatedAtUtc.AddDays(1), "General consultation request.",
                CreatedAtUtc, ActorId);
        }

        private static MedicalRecord CreateMedicalRecord()
        {
            return new MedicalRecord("MDR-2026-000001", StudentId,
                CreatedAtUtc, ActorId);
        }

        private static void AddConsultation(MedicalRecord record)
        {
            record.AddConsultation("CON-2026-000001", "CAP-2026-000001",
                ClinicianEmployeeId, CreatedAtUtc.AddHours(2),
                "Confidential clinical notes.", "Confidential clinical assessment.",
                "Confidential treatment plan.", CreatedAtUtc.AddHours(2), ActorId);
        }

        private static MedicalClearance CreateMedicalClearance()
        {
            return new MedicalClearance("MCL-2026-000001", "MCH-2026-000001",
                StudentId, "MDR-2026-000001", "Medical clearance requested.",
                CreatedAtUtc, ActorId);
        }
    }
}
